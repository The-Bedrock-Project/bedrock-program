...
// ── BRAND ───────────────────────────────────────────────────────────────────
// Primary: #0A0A0A (black), #FAFAFA (white), #C9A84C (gold)
...
function GoldLine() {
  return <div style={{ height: 1, background: "linear-gradient(90deg, transparent, #C9A84C 40%, #C9A84C 60%, transparent)", opacity: 0.5 }} />;
}
...
function BtnPrimary({ href, children, internal = false }) {
  return (
    <a
      href={href}
...
function BtnOutline({ href, children, dark = false, internal = false }) {
  const col = dark ? "#C9A84C" : "#8a6e2f";
  return (
    <a
      href={href}
      target={internal ? undefined : "_blank"}
      ...
      onMouseLeave={e => { e.currentTarget.style.borderColor = col; e.currentTarget.style.color = col; e.currentTarget.style.transform = "translateY(0)"; }}
    >
      {children}
    </a>
  );
...
function Navbar() {
  ...
  return (
    <nav style={{
      ...
      {/* NOHMAD logo — inverted when scrolled (dark bg → white logo; light bg → black logo) */}
          ...
          <li key={href}>
            <a
              ...
              style={{
                ...
                fontSize: "0.62rem",
                letterSpacing: "0.1em",
                color: scrolled ? "#444" : "rgba(250,250,250,0.7)",
                textDecoration: "none",
                textTransform: "uppercase",
                transition: "color 0.2s"
              }}
              onMouseEnter={e => e.currentTarget.style.color = "#C9A84C"}
              onMouseLeave={e => e.currentTarget.style.color = scrolled ? "#444" : "rgba(250,250,250,0.7)"}
            >
              {label}
            </a>
          </li>
      ...
      <button
        ...
        className="hamburger"
        style={{ display: "none", background: "none", border: "none", cursor: "pointer", color: "#C9A84C", fontSize: "1.4rem" }}
      >
        ☰
      </button>
      ...
      {open && (
        <div style={{
          ...
          <button
            ...
            style={{ position: "absolute", top: "1.5rem", right: "1.5rem", background: "none", border: "none", cursor: "pointer", fontSize: "1.5rem", color: "#666" }}
          >
            ✕
          </button>
          <img src="/NohMad.png" alt="NohMad LLC" style={{ height: 32, filter: "invert(1)", marginBottom: "1rem" }} />
          {links.map(([href, label]) => (
            <a
              key={href}
              href={href}
              onClick={() => setOpen(false)}
              style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2.5rem", letterSpacing: "0.08em", color: "#FAFAFA", textDecoration: "none" }}
            >
              {label}
            </a>
          ))}
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setOpen(false)}
            style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2.5rem", letterSpacing: "0.08em", color: "#C9A84C", textDecoration: "none" }}
          >
            Book
          </a>
        </div>
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        backgroundImage: "radial-gradient(ellipse at 15% 55%, rgba(201,168,76,0.07) 0%, transparent 55%), radial-gradient(ellipse at 85% 15%, rgba(201,168,76,0.04) 0%, transparent 50%)",
        pointerEvents: "none"
      }} />
      ...
      <div style={{ maxWidth: 780, position: "relative", zIndex: 1 }}>
        ...
        <blockquote style={{
          borderLeft: "3px solid #C9A84C", paddingLeft: "1.25rem",
          marginBottom: "3rem",
          opacity: 0, animation: "fadeUp 0.8s 0.7s forwards"
        }}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(0.95rem,2vw,1.1rem)", fontStyle: "italic", color: "rgba(240,223,160,0.85)", fontWeight: 300 }}>
            "Everyone then who hears these words of mine and does them will be like a wise man who built his house on the rock."
          </p>
          <cite style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.6rem", letterSpacing: "0.1em", color: "#555", fontStyle: "normal", display: "block", marginTop: "0.5rem" }}>— Matthew 7:24</cite>
        </blockquote>
...
function Statement() {
  return (
    <section id="statement" style={{ background: "#FAFAFA", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <Reveal delay={0.15}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2vw,1.15rem)", color: "#444", fontWeight: 300, lineHeight: 1.75, marginBottom: "2rem" }}>
        ...
        <Reveal delay={0.2}>
          <div style={{ margin: "2.5rem 0", padding: "2rem", borderLeft: "4px solid #C9A84C", background: "#f7f2e8" }}>
            <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(1.6rem,4vw,2.4rem)", lineHeight: 1.1, color: "#0A0A0A" }}>
        ...
        <Reveal delay={0.25}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2vw,1.15rem)", color: "#444", fontWeight: 300, lineHeight: 1.75, marginBottom: "1.5rem" }}>
        ...
        <Reveal delay={0.3}>
          <div style={{ margin: "2.5rem 0", padding: "2rem", border: "1px solid rgba(201,168,76,0.35)", textAlign: "center", background: "rgba(201,168,76,0.04)" }}>
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.1rem,2.5vw,1.4rem)", fontStyle: "italic", color: "#0A0A0A", fontWeight: 400 }}>
        ...
        <Reveal delay={0.35}>
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.7rem", letterSpacing: "0.1em", color: "#888", marginBottom: "1.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
            ...
            <BtnOutline href={LINKS.zenodoDownload}>Download Statement</BtnOutline>
          </div>
        </Reveal>
      </div>
    </section>
...
function MaintenanceTest() {
  ...
  return (
    <section id="test" style={{ background: "#0A0A0A", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <Reveal delay={0.15}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2vw,1.15rem)", color: "rgba(250,250,250,0.55)", fontWeight: 300, lineHeight: 1.75, marginBottom: "2rem" }}>
        ...
        <Reveal delay={0.2}>
          <div style={{ margin: "2rem 0 3rem", padding: "1.5rem", borderLeft: "4px solid #C9A84C", background: "rgba(201,168,76,0.06)" }}>
            <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(1.4rem,4vw,2rem)", color: "#FAFAFA", lineHeight: 1.1 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem", margin: "1rem 0 3rem" }}>
          {sigs.map((s, i) => (
            <Reveal key={s.n} delay={i * 0.1}>
              <div
                style={{ border: "1px solid rgba(201,168,76,0.2)", padding: "1.75rem", background: "rgba(201,168,76,0.03)", transition: "border-color 0.3s, background 0.3s", cursor: "default" }}
              ...
              >
                ...
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1rem", color: "rgba(250,250,250,0.5)", fontWeight: 300, lineHeight: 1.7 }}>{s.body}</p>
              </div>
            </Reveal>
          ))}
        </div>
        ...
        <Reveal delay={0.15}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", margin: "1rem 0 2.5rem" }}>
            <div style={{ padding: "1.75rem", background: "rgba(20,50,20,0.5)", border: "1px solid rgba(80,160,80,0.3)" }}>
            ...
            <div style={{ padding: "1.75rem", background: "rgba(60,15,15,0.5)", border: "1px solid rgba(160,60,60,0.3)" }}>
        ...
        <Reveal delay={0.2}>
          <div style={{ padding: "2rem", border: "1px solid rgba(201,168,76,0.3)", textAlign: "center", background: "rgba(201,168,76,0.04)", marginBottom: "2.5rem" }}>
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2.5vw,1.3rem)", fontStyle: "italic", color: "rgba(240,223,160,0.85)", fontWeight: 300 }}>
...
function Research() {
  const cards = [
    ...
    { label: "Bedrock Statement", desc: "The foundational constraint document. Download directly.",          href: LINKS.zenodoDownload, cta: "Download →" },
    { label: "Maintenance Test",  desc: "The primary public instrument. Three steps. Any domain.",           href: LINKS.maintenance,   cta: "Download →" },
  ];

  return (
    <section id="research" style={{ background: "#FAFAFA", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <Reveal delay={0.15}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2vw,1.15rem)", color: "#444", fontWeight: 300, lineHeight: 1.75, marginBottom: "2.5rem" }}>
          ...
          {cards.map((card, i) => (
            <Reveal key={card.label} delay={i * 0.08}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ display: "block", padding: "1.5rem", border: "1px solid rgba(201,168,76,0.25)", background: "rgba(201,168,76,0.02)", textDecoration: "none", height: "100%", transition: "all 0.25s" }}
              ...
              >
                <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.1rem", letterSpacing: "0.08em", color: "#0A0A0A", marginBottom: "0.5rem" }}>{card.label}</p>
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.9rem", color: "#666", fontWeight: 300, lineHeight: 1.6, marginBottom: "1rem" }}>{card.desc}</p>
        ...
        {/* What is not public */}
        <Reveal delay={0.35}>
          <div style={{ padding: "1.5rem", borderLeft: "3px solid #C9A84C", background: "#f7f2e8", marginBottom: "1.5rem" }}>
            ...
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.95rem", color: "#444", fontWeight: 300, lineHeight: 1.7 }}>
        ...
        <Reveal delay={0.4}>
          <a
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = "#C9A84C"; e.currentTarget.style.background = "linear-gradient(135deg, rgba(201,168,76,0.13) 0%, rgba(201,168,76,0.05) 100%)"; e.currentTarget.style.transform = "translateY(-2px)"; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(201,168,76,0.4)"; e.currentTarget.style.background = "linear-gradient(135deg, rgba(201,168,76,0.07) 0%, rgba(201,168,76,0.02) 100%)"; e.currentTarget.style.transform = "translateY(0)"; }}
          >
            <div style={{ flexShrink: 0, width: 48, height: 48, background: "rgba(201,168,76,0.15)", border: "1px solid rgba(201,168,76,0.35)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.4rem" }}>
              📖
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.58rem", letterSpacing: "0.15em", color: "#8a6e2f", marginBottom: "0.25rem", textTransform: "uppercase" }}>Book · Dr. Alex Toal · NohMad LLC</p>
              <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.2rem", letterSpacing: "0.06em", color: "#0A0A0A", marginBottom: "0.25rem" }}>The Unmanipulable Man</p>
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.88rem", color: "#666", fontWeight: 300, lineHeight: 1.5 }}>A Structural Character Study of Jesus Christ. Available on Amazon Kindle. All proceeds fund The Bedrock Program.</p>
            </div>
            <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.62rem", letterSpacing: "0.1em", color: "#C9A84C", flexShrink: 0, whiteSpace: "nowrap" }}>Read →</p>
          </a>
        </Reveal>
      </div>
    </section>
...
function MissionStrip() {
  return (
    <section style={{ background: "#C9A84C", padding: "5rem 2rem" }}>
      <div style={{ maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
        <Reveal>
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.62rem", letterSpacing: "0.22em", color: "rgba(10,10,10,0.55)", textTransform: "uppercase", marginBottom: "1.5rem" }}>
            Why Faith Led the Research
          </p>
        </Reveal>
        <Reveal delay={0.1}>
          <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(2rem,6vw,3.5rem)", lineHeight: 1, letterSpacing: "0.03em", color: "#0A0A0A", marginBottom: "1.5rem" }}>
            We Did Not Find This By Accident
          </h2>
        </Reveal>
        <Reveal delay={0.2}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2vw,1.2rem)", color: "#0A0A0A", fontWeight: 400, lineHeight: 1.75, maxWidth: 620, margin: "0 auto 1.5rem" }}>
        ...
        <Reveal delay={0.3}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.1rem,2.5vw,1.4rem)", fontStyle: "italic", color: "#0A0A0A", fontWeight: 600 }}>
...
function Support() {
  return (
    <section id="support" style={{ background: "#0A0A0A", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <Reveal delay={0.15}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2vw,1.15rem)", color: "rgba(250,250,250,0.5)", fontWeight: 300, lineHeight: 1.75, marginBottom: "3rem" }}>
          ...
          {TIERS.map((t, i) => (
            <Reveal key={t.title} delay={i * 0.08}>
              <div style={{ padding: "1.75rem", border: "1px solid rgba(201,168,76,0.2)", background: "rgba(201,168,76,0.03)", height: "100%" }}>
                ...
                <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1rem", letterSpacing: "0.08em", color: "#FAFAFA", marginBottom: "0.75rem" }}>{t.title}</p>
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.9rem", fontWeight: 300, lineHeight: 1.65, color: "rgba(250,250,250,0.45)" }}>{t.desc}</p>
              </div>
            </Reveal>
          ))}
        </div>
...
function Team() {
  return (
    <section id="team" style={{ background: "#FAFAFA", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <Reveal delay={0.15}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1rem,2vw,1.15rem)", color: "#444", fontWeight: 300, lineHeight: 1.75, marginBottom: "3rem" }}>
          ...
          {TEAM.map((m, i) => (
            <Reveal key={m.name} delay={i * 0.1}>
              <div style={{ padding: "2rem 1.5rem", borderTop: "2px solid #C9A84C", borderRight: i % 2 === 0 ? "1px solid rgba(201,168,76,0.15)" : "none" }}>
                <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.3rem", letterSpacing: "0.06em", color: "#0A0A0A", marginBottom: "0.25rem" }}>{m.name}</p>
                ...
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.9rem", color: "#666", fontWeight: 300, lineHeight: 1.65, marginBottom: "0.75rem" }}>{m.fn}</p>
                <a
                  href={`mailto:${m.email}`}
                  style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.6rem", letterSpacing: "0.08em", color: "#8a6e2f", textDecoration: "none", transition: "color 0.2s" }}
                  onMouseEnter={e => e.currentTarget.style.color = "#C9A84C"}
...
function Footer() {
  const footerLinks = [
    ...
    [LINKS.zenodo,                    "Zenodo"],
    [LINKS.amazon,                    "Book"],
    [LINKS.givesendgo,                "Donate"],
    ["mailto:NohMadllc@journalist.com","Contact"],
  ];

  return (
    <footer style={{ background: "#050505", padding: "4rem 2rem", textAlign: "center", borderTop: "1px solid rgba(201,168,76,0.12)" }}>
      {/* NOHMAD logo in footer */}
      <div style={{ marginBottom: "1.5rem" }}>
        <img src="/NohMad.png" alt="NohMad LLC" style={{ height: 24, filter: "invert(1)", opacity: 0.7 }} />
      </div>

      <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.1rem", letterSpacing: "0.15em", color: "#C9A84C", marginBottom: "0.5rem" }}>
        The Bedrock Program
      </p>
      <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.58rem", letterSpacing: "0.18em", color: "#333", textTransform: "uppercase", marginBottom: "2rem" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "1.5rem", flexWrap: "wrap", marginBottom: "2rem" }}>
        {footerLinks.map(([href, label]) => (
          <a
            ...
            rel="noopener noreferrer"
            style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.6rem", letterSpacing: "0.1em", color: "#333", textDecoration: "none", textTransform: "uppercase", transition: "color 0.2s" }}
            onMouseEnter={e => e.currentTarget.style.color = "#C9A84C"}
      ...
      <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.56rem", color: "#222", letterSpacing: "0.06em" }}>
